...
const Navigation = () => {
    ...
    if (store.user && store.user.role === 'ADMIN') {
        ...
        return (
            ...
            // {...store}
            // disabledPaths={basketDisabledpatnames}
            // pathname={pathname}
            // />
            123
        )
  ...
  return (
    <nav className='navigation' ref={navbar}>
        ...
        <ul className='navigation-menu-main'>
            ...
            <li><NavLink activeClassName='navigation-menu-active' to={ROUTE.FEATURE_PRODUCTS}>Featured</NavLink></li>
            ...
            <li className='navigation-menu-item'>
                <BasketToggle>
                    ...
                    <button
                        ...
                        disabled={basketDisabledpatnames.includes(pathname)}
